<head>
    ...
    <link rel="stylesheet" href="Farmer/assets/vendor/fonts/boxicons.css" />
    ...
    <link rel="stylesheet" href="Farmer/assets/vendor/libs/apex-charts/apex-charts.css" />

    <!-- Page CSS -->

    <!-- Helpers -->
    <script src="Farmer/assets/vendor/js/helpers.js"></script>


    <script src="Farmer/assets/js/config.js"></script>
</head>
